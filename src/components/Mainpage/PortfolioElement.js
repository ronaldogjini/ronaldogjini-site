...
function PortfolioElement({ project }) {
    return (
        <div class="py-4 px-4">
            <div class=" ">
                <div class="bg-white relative shadow rounded-lg text-gray-800 hover:shadow-lg transform hover:scale-105 duration-500">
                    ...
                    <div class="py-2 px-2">
                        <div class=" font-bold font-title text-center">{project.title}</div>
